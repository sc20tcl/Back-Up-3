...
def repeatedly_call_url(url, interval_seconds, max_calls):
    ...
    # continuously calls the url until the limit is reached
...
#  To simulate continuous sensor readings in 5 second intervals Q3
repeatedly_call_url("http://localhost:7071/api/sensoreCapture", 5, 20)


##### !!! to record scaling data Q1
# timestamp = []
